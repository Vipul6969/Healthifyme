    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to HealthifyMe, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using HealthifyMe, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          HealthifyMe is designed to simplify healthcare access. You can choose
